...
{
    [TestFixture]
    public class DuplicateAssetsSetting : TestGeneric
    {
        long _CountOfDbo;
        long _CountOfIdx;
        ...
        public new void SetUp()
        {
            ...
            _CountOfDbo = RegisterService.duplicateAssetsRepo.GetAll_dbo().Count();
            _CountOfIdx = RegisterService.duplicateAssetsRepo.GetAll_idaxExport().Count();
